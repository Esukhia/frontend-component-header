...
export const postSetLang = code => {
  ...
  return getAuthenticatedHttpClient().post(`${getConfig().LMS_BASE_URL}/i18n/setlang/`, formData, {
    isPublic: true,
    headers: {
 ...
 * @returns {Promise}
 */
export const patchLanguagePreference = (username, code) => getAuthenticatedHttpClient().patch(`${getConfig().LMS_BASE_URL}/api/user/v1/preferences/${username}`, {
  'pref-lang': code
}, {
  headers: {
